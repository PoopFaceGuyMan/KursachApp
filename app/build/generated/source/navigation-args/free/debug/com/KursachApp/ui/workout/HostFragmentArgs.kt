...
public data class HostFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): HostFragmentArgs {
      bundle.setClassLoader(HostFragmentArgs::class.java.classLoader)
      ...
      return HostFragmentArgs(__workoutId, __pendingIntent)
    }
  }
}
