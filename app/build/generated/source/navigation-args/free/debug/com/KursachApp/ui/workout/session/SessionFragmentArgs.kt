...
public data class SessionFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): SessionFragmentArgs {
      bundle.setClassLoader(SessionFragmentArgs::class.java.classLoader)
      ...
      return SessionFragmentArgs(__workoutId, __pendingIntent)
    }
  }
}
