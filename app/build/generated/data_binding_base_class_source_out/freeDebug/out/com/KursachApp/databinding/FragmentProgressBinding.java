...
public final class FragmentProgressBinding implements ViewBinding {
  ...
  private FragmentProgressBinding(@NonNull LinearLayout rootView, @NonNull TextView dateTv,
  ...
  public static FragmentProgressBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProgressBinding((LinearLayout) rootView, dateTv, recyclerView);
    }
