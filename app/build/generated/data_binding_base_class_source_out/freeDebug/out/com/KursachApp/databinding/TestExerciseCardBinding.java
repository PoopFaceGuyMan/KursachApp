...
public final class TestExerciseCardBinding implements ViewBinding {
  @NonNull
  ...
  private TestExerciseCardBinding(@NonNull MaterialCardView rootView,
  ...
  @NonNull
  public static TestExerciseCardBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static TestExerciseCardBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.test_exercise_card, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static TestExerciseCardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new TestExerciseCardBinding((MaterialCardView) rootView, binding_actionBar,
