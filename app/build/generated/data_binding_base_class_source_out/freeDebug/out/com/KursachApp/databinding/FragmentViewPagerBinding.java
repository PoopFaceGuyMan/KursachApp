...
public final class FragmentViewPagerBinding implements ViewBinding {
  ...
  private FragmentViewPagerBinding(@NonNull RelativeLayout rootView, @NonNull ViewPager2 pager,
  ...
  public static FragmentViewPagerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentViewPagerBinding((RelativeLayout) rootView, pager, tabLayout);
    }
