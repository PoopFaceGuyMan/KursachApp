package com.KursachApp.provider
...
class MyContentProvider : ContentProvider() {
    ...
    override fun getType(uri: Uri): String {
        return when (sUriMatcher.match(uri)) {
            1 -> {
                "vnd.android.cursor.dir/com.KursachApp.free.provider.set"
            }
            2 -> {
                "vnd.android.cursor.dir/com.KursachApp.free.provider.exercise"
            }
            3 -> {
                "vnd.android.cursor.dir/com.KursachApp.free.provider.workout"
            }
            else -> {
                throw IllegalArgumentException(
                    "Uri does not match a known table."
    ...
    companion object {
        const val AUTHORITY = "com.KursachApp.free.provider"
    }
